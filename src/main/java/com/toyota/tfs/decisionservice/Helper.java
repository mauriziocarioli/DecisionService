...
@org.kie.api.definition.type.Label("Helper")
@org.kie.api.definition.type.Description("This class holds accessory fields and functions")
public class Helper implements java.io.Serializable {

	static final long serialVersionUID = 1L;
	static Long ListID;

	@org.kie.api.definition.type.Description("random number in [0,1) used in early stage business rules")
	private double rand1;
	@org.kie.api.definition.type.Description("random number in [0,1) used for load balancing ListId's of late stage accounts")
